...
| Блок | Материал | Что делает |
|------|----------|-----------|
| **Блок старта игры** | Железный блок | Начать игру (только для `rounds.admin`) |
| **Блок завершение игры** | Редстоун блок | Завершить игру (только для `rounds.admin`) |
| **Блок синей команды для лобби** | Синяя шерсть | Добавляет игрока в синюю команду |
| **Блок красной команды для лобби** | Красная шерсть | Добавляет игрока в красную команду |
| **Блок жёлтой команды для лобби** | Жёлтая шерсть | Добавляет игрока в жёлтая команду |
| **Блок зелёной команды для лобби** | Зелёная шерсть | Добавляет игрока в зелёную команду |
...
| `homing-on-block` | Самонаведение пуль на N секунд при блоке |
...
| `saw` | Пила (Поле урона вокруг при блокировке) |
| `shockwave` | Ударная волна при блокировке (отбрасывание) |
