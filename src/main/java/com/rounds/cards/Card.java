...
public class Card {
    ...
    private void applyEffect(PlayerData data, String key, double value) {
        switch (key) {
            ...
            case "cold-level", "cold-lvl", "cold_level", "cold_lvl": data.coldLvl = PlayerData.round2(Math.max(data.coldLvl + value, 0)); break;
            case "poison": data.poison = PlayerData.round2(Math.max(data.poison + value, 0)); break;
            case "toxic-cloud", "toxic_cloud": data.toxicCloud = PlayerData.round2(Math.max(data.toxicCloud + value, 0)); break;
            case "poison-level", "poison-lvl", "poison_level", "poison_lvl": data.poisonLvl = PlayerData.round2(Math.max(data.poisonLvl + value, 0)); break;
            case "homing": data.homing = PlayerData.round2(Math.max(data.homing + value, 0)); break;
            case "homing-on-block", "homing_on_block": data.homingOnBlock = PlayerData.round2(Math.max(data.homingOnBlock + value, 0)); break;
            ...
            case "empower-charge", "empower_charge": data.empowerCharge = PlayerData.round2(Math.max(data.empowerCharge + value, 0)); break;
            case "dark-strength", "dark_strength": data.darkStrength = PlayerData.round2(Math.max(data.darkStrength + value, 0)); break;
            case "big-bullet", "big_bullet": data.bigBullet = PlayerData.round2(Math.max(data.bigBullet + value, 0)); break;
            case "bomb-bullet", "bomb_bullet": data.bombBullet = PlayerData.round2(Math.max(data.bombBullet + value, 0)); break;
            case "bomb-on-block", "bomb_on_block": data.bombOnBlock = PlayerData.round2(Math.max(data.bombOnBlock + value, 0)); break;
            case "target-bounce", "tg-bounce", "target_bounce", "tg_bounce": data.tgBounce = PlayerData.round2(Math.max(data.tgBounce + value, 0)); break;
            case "shield": data.shieldCooldown = PlayerData.round2(Math.max(data.shieldCooldown + value, 0)); break;
            case "truster", "truster-lvl", "truster_lvl": data.trusterLvl = PlayerData.round2(Math.max(data.trusterLvl + value, 0)); break;
